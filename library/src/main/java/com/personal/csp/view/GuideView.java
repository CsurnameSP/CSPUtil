...
public class GuideView extends RelativeLayout implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        if (customGuideView != null) {
            ...
            if (direction != null) {
                ...
                switch (myShape) {
                    ...
                    case ELLIPSE://椭圆
                        //RectF对象
                        int x1 = getTargetViewRadiusX();
                        int y1 = getTargetViewRadiusY();
                        left = center[0] - x1;
                        right = center[0] + x1;
                        top = center[1] - y1;
                        bottom = center[1] + y1;
                    ...
                    case RECTANGULAR://圆角矩形
                        //RectF对象
                        int x2 = getTargetViewRadiusX();
                        int y2 = getTargetViewRadiusY();
                        left = center[0] - x2;
                        right = center[0] + x2;
                        top = center[1] - y2;
                        bottom = center[1] + y2;
    ...
    private int getTargetViewRadiusX() {
        int[] size = getTargetViewSize();
        int x = size[0];
        return (x / 2);
    }

    private int getTargetViewRadiusY() {
        int[] size = getTargetViewSize();
        int y = size[1];
        return (y / 2);
    }
        ...
        if (myShape != null) {
            ...
            switch (myShape) {
                ...
                case ELLIPSE://椭圆
                    ...
                    int x1 = getTargetViewRadiusX();
                    int y1 = getTargetViewRadiusY();
                    oval.left = center[0] - x1;                              //左边
                    oval.top = center[1] - y1;                                   //上边
                    oval.right = center[0] + x1;                             //右边
                    oval.bottom = center[1] + y1;                                //下边
                ...
                case RECTANGULAR://圆角矩形
                    ...
                    int x2 = getTargetViewRadiusX();
                    int y2 = getTargetViewRadiusY();
                    oval.left = center[0] - x2;                              //左边
                    oval.top = center[1] - y2;                                   //上边
                    oval.right = center[0] + x2;                             //右边
                    oval.bottom = center[1] + y2;                                //下边
